...
export default function Viewport({children,initialView,viewCapture}:{children:ReactNode;initialView?:SavedView;viewCapture:MutableRefObject<(()=>SavedView)|null>}){
